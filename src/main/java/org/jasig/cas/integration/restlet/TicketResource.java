...
public class TicketResource extends Resource {
    ...
    public final void acceptRepresentation(final Representation entity) throws ResourceException {
        try {
            ...
            jsonObject.put("description", getResponse().getStatus().getDescription());
            jsonObject.put("ticket_url", ticket_ref.toString());
            getResponse().setEntity(jsonObject.toJSONString(), MediaType.TEXT_HTML);
